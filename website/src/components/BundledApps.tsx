  ...
  return (
    <section id="apps">
      <div class="container">
        ...
        <p class="lede">
          Takos distribution と一緒に ship される 1st-party の InstallableApp。
          新規 space 作成と同時に install 済み、 必要なければ uninstall できる。
        </p>
        <div class="features">
          <For each={APPS}>
            {(a) => (
              <article class="feature">
                <h4>{a.name} <span class="feature-tag">{a.tag}</span></h4>
                <p>{a.body}</p>
              </article>
            )}
          </For>
