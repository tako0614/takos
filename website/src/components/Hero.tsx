    ...
    <section class="hero">
      ...
      <div class="container hero-grid">
        <div class="hero-copy">
          ...
          <p class="lede">
            Chat / agent / memory / space を core に持つ、 self-hostable な AI
            chat product。 <code>takos-docs</code> や <code>yurucommu</code>
            {" "}
            なんかの bundled apps は新規 space 作成と同時に auto-install
            される。 history も memory も自分の VM の外に出ない。
          </p>
          <div class="cta-row">
            <a
        ...
        <div class="hero-terminal">
          <CodeBlock terminal>
            ...
            {"\n"}
            <span class="k">$</span>{" "}
            open https://cloud.takosumi.com/dashboard/use-takos{"\n"}
            <span class="k">$</span>&nbsp;&nbsp;&nbsp;→ Account / Space /
            launch{"\n"}
            <span class="c">
