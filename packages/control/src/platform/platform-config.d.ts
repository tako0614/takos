import type { ResolvedRouting, RoutingStore, RoutingTarget, WeightedDeploymentTarget } from '../application/services/routing/routing-models.ts';
import type { AiBinding, DurableNamespaceBinding, KvStoreBinding, ObjectStoreBinding, PlatformExecutionContext, QueueBinding, SqlDatabaseBinding, VectorIndexBinding } from '../shared/types/bindings.ts';
...
export type PlatformDeployProviderConfig = WorkersDispatchDeployProviderConfig | OciDeployProviderConfig | EcsDeployProviderConfig | CloudRunDeployProviderConfig | K8sDeployProviderConfig;
