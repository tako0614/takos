export declare const RUN_QUEUE_MESSAGE_VERSION = 2;
export declare const WORKFLOW_QUEUE_MESSAGE_VERSION = 3;
export declare const DEPLOYMENT_QUEUE_MESSAGE_VERSION = 1;
export declare const INDEX_QUEUE_MESSAGE_VERSION = 1;
