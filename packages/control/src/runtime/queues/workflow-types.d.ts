import type { R2Bucket, DurableObjectNamespace, Queue } from '../../shared/types/bindings.ts';
...
export declare function createInitialState(): JobExecutionState;
...
export declare function asDurableObjectFetcher(stub: unknown): DurableObjectFetchLike;
