 ...
 */
export declare function createResolver<T>(config: ResolverConfig<T>): (dataDir: string | null) => Promise<T>;
/**
...
export declare function createResolverWithRedis<T>(config: ResolverWithRedisConfig<T>): (redisUrl: string | null, dataDir: string | null) => Promise<T>;
