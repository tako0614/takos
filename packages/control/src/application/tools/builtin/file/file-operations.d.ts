 ...
 * ```
 */
export declare function setupFileOperation(args: Record<string, unknown>, context: ToolContext): Promise<FileOperationContext>;
/**
 ...
 * ```
 */
export declare function handleSessionApiResponse<T = unknown>(response: Response, operation: string): Promise<T>;
