 ...
 * names (d1 / r2 / kv / ...). The flat schema uses backend-independent names
 ...
 */
const RESOURCE_TYPE_ALIASES: Record<string, CanonicalManifestResourceType> = {
  d1: "sql",
  r2: "object-store",
  kv: "key-value",
  secretRef: "secret",
...
export function inferCanonicalResourceDescriptor(
  ...
  const normalizedType = RESOURCE_TYPE_ALIASES[manifestType];
