...
export type DeployState = 'pending' | 'uploading_bundle' | 'creating_resources' | 'deploying_worker' | 'setting_bindings' | 'routing' | 'completed' | 'failed' | 'rolled_back';
...
export type Deployment = DeploymentIdentity & DeploymentArtifact & DeploymentConfig & DeploymentState & DeploymentProvenance & DeploymentTimestamps;
