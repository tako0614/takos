...
export async function createMessage(
  ...
  try {
    ...
    logWarn('Failed to update thread updatedAt', { module: 'services/threads/threads', detail: err });
  }
  ...
  if (input.role === 'user' && sequence === 0 && !thread.title) {
    ...
    try {
      ...
      logWarn('Failed to auto-set thread title', { module: 'services/threads/threads', detail: err });
    }
  }
