...
export const branches = sqliteTable("branches", {
  ...
  isDefault: integer("is_default", { mode: "boolean" }).notNull().default(
    false,
  ),
  isProtected: integer("is_protected", { mode: "boolean" }).notNull().default(
    false,
  ),
  ...timestamps,
}, (table) => ({
...
export const repoReleaseAssets = sqliteTable("repo_release_assets", {
  ...
  uniqReleaseAssetKey: uniqueIndex("idx_repo_release_assets_release_asset_key")
...
export const repoReleases = sqliteTable("repo_releases", {
  ...
  isPrerelease: integer("is_prerelease", { mode: "boolean" }).notNull().default(
    false,
  ),
...
export const repositories = sqliteTable("repositories", {
  ...
  gitEnabled: integer("git_enabled", { mode: "boolean" }).notNull().default(
    false,
  ),
