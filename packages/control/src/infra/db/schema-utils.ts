...
const _createdAt = text("created_at").notNull().$defaultFn(() =>
  new Date().toISOString()
);
const _updatedAt = text("updated_at").notNull().$defaultFn(() =>
  new Date().toISOString()
...
export const timestamps: {
  createdAt: typeof _createdAt;
  updatedAt: typeof _updatedAt;
} = {
  createdAt: _createdAt,
  updatedAt: _updatedAt,
};
