 ...
 */
export type PullRequestEventType = 'opened' | 'edited' | 'closed' | 'reopened' | 'synchronize' | 'converted_to_draft' | 'ready_for_review' | 'locked' | 'unlocked' | 'review_requested' | 'review_request_removed' | 'auto_merge_enabled' | 'auto_merge_disabled';
/**
...
export type Permissions = 'read-all' | 'write-all' | Record<string, PermissionLevel>;
/**
 ...
 */
export type StepsContext = Record<string, {
    outputs: Record<string, string>;
 ...
 */
export type NeedsContext = Record<string, {
    outputs: Record<string, string>;
 ...
 */
export type StepExecutor = (step: Step, context: ExecutionContext) => Promise<StepResult>;
/**
 * Action resolver function type
 */
export type ActionResolver = (uses: string) => Promise<{
    run: StepExecutor;
} | null>;
//# sourceMappingURL=workflow-models.d.ts.map