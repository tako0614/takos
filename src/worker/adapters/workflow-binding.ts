/**
 * Provider-neutral implementation of the Workflow binding.
 *
 * Stores workflow instance state in the SQL database.
...
// Minimal DB interface (compatible with SqlDatabaseBinding and PostgreSQL adapter)
interface DbLike {
