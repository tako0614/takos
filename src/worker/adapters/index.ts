/**
 * Adapters barrel — re-exports all cloud-backend adapter bindings
 * and local runtime emulation layer for use as `takos-worker/bindings`.
 */
...
// --- Local runtime emulation (Redis-backed DO / SSE) ---
export {
