...
/** The `type` parameter accepted by `KvStoreBinding.get()`. */
export type KVValueType = "text" | "json" | "arrayBuffer" | "stream";

/** Shape returned by `KvStoreBinding.getWithMetadata()`. */
...
/** Shape of a single key entry returned by `KvStoreBinding.list()`. */
...
/** Shape returned by `KvStoreBinding.list()`. */
 ...
 * `type` parameter — callers cast as needed to satisfy the KvStoreBinding
 * overloads.
 */
