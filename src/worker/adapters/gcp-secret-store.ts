...
async function requestJson<T>(
  ...
  // GCP Secret Manager reads are on tenant request paths; cap stalls at 10s
  // so handlers fail fast rather than hanging on a slow upstream. Respect a
  // caller-supplied signal when present.
