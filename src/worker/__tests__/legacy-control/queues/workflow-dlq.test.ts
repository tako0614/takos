...
import { handleWorkflowJobDlq } from "../../../runtime/queues/workflow-dlq.ts";
...
function createEnv(
  ...
  return {
    ...
    WORKFLOW_QUEUE: noopMessageQueueBinding(),
    ...overrides,
  } as WorkflowQueueEnv;
}
...
// shape because the fake SQL database doesn't actually persist rows.
