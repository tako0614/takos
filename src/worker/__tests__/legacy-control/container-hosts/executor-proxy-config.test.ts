...
import {
  ...
  generateProxyToken,
} from "@/container-hosts/executor-proxy-config";
...
Deno.test("buildAgentExecutorContainerEnvVars - forwards configured provider keys", () => {
  assertEquals(
    buildAgentExecutorContainerEnvVars({
      TAKOS_AGENT_CONTROL_RPC_BASE_URL: "https://executor.example",
