/**
 * Message queue resolver — selects SQS/PubSub/Redis/persistent/in-memory per queue.
 */
...
import { createInMemoryQueue } from "../../local-platform/in-memory-bindings.ts";
import { createPersistentQueue } from "../../local-platform/persistent-bindings.ts";
...
// ---------------------------------------------------------------------------
// Per-message-queue resolver builder
// ---------------------------------------------------------------------------
