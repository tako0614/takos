...
function buildBaseConfig(isLocal: boolean) {
  return {
    ...
    TAKOS_FEATURED_APPS_PREINSTALL: optionalEnv(
    ...
    TAKOS_FEATURED_APP_INSTALL_URL: optionalEnv(
...
export async function createNodeWebEnv(): Promise<Env> {
  ...
  return {
    ...
    TAKOS_MCP_OAUTH_PREREGISTRATIONS_JSON:
      config.TAKOS_MCP_OAUTH_PREREGISTRATIONS_JSON,
    ...
    TAKOS_FEATURED_APP_INSTALL_SUBJECT:
      config.TAKOS_FEATURED_APP_INSTALL_SUBJECT,
