...
function buildBaseConfig(isLocal: boolean) {
  return {
    ...
    TAKOS_FEATURED_APP_REPOSITORIES_JSON: optionalJsonArrayEnv(
      "TAKOS_FEATURED_APP_REPOSITORIES_JSON",
    ),
    TAKOS_FEATURED_APPS_PREINSTALL: optionalEnv("TAKOS_FEATURED_APPS_PREINSTALL"),
    TAKOS_FEATURED_APP_REF: optionalEnv("TAKOS_FEATURED_APP_REF"),
    TAKOS_FEATURED_APP_REF_TYPE: optionalEnv("TAKOS_FEATURED_APP_REF_TYPE"),
    TAKOS_FEATURED_APP_BACKEND: optionalEnv("TAKOS_FEATURED_APP_BACKEND"),
    TAKOS_FEATURED_APP_ENV: optionalEnv("TAKOS_FEATURED_APP_ENV"),
    TAKOS_FEATURED_APP_INSTALL_URL: optionalEnv("TAKOS_FEATURED_APP_INSTALL_URL"),
    TAKOS_FEATURED_APP_INSTALL_TOKEN: optionalEnv(
      "TAKOS_FEATURED_APP_INSTALL_TOKEN",
    ),
    TAKOS_FEATURED_APP_INSTALL_ACCOUNT_ID: optionalEnv(
      "TAKOS_FEATURED_APP_INSTALL_ACCOUNT_ID",
    ),
    TAKOS_FEATURED_APP_INSTALL_SUBJECT: optionalEnv(
      "TAKOS_FEATURED_APP_INSTALL_SUBJECT",
    ),
    TAKOS_FEATURED_APP_INSTALL_MODE: optionalEnv(
      "TAKOS_FEATURED_APP_INSTALL_MODE",
    ),
    TAKOS_FEATURED_APP_INSTALL_RUNTIME_BASE_URL: optionalEnv(
...
export async function createNodeWebEnv(): Promise<Env> {
  ...
  return {
    ...
    TAKOS_FEATURED_APP_CATALOG_JSON:
      config.TAKOS_FEATURED_APP_CATALOG_JSON,
    TAKOS_FEATURED_APP_REPOSITORIES_JSON:
      config.TAKOS_FEATURED_APP_REPOSITORIES_JSON,
    TAKOS_FEATURED_APPS_PREINSTALL: config.TAKOS_FEATURED_APPS_PREINSTALL,
    TAKOS_FEATURED_APP_REF: config.TAKOS_FEATURED_APP_REF,
    TAKOS_FEATURED_APP_REF_TYPE: config.TAKOS_FEATURED_APP_REF_TYPE,
    TAKOS_FEATURED_APP_BACKEND: config.TAKOS_FEATURED_APP_BACKEND,
    TAKOS_FEATURED_APP_ENV: config.TAKOS_FEATURED_APP_ENV,
    TAKOS_FEATURED_APP_INSTALL_URL: config.TAKOS_FEATURED_APP_INSTALL_URL,
    TAKOS_FEATURED_APP_INSTALL_TOKEN: config.TAKOS_FEATURED_APP_INSTALL_TOKEN,
    TAKOS_FEATURED_APP_INSTALL_ACCOUNT_ID:
      config.TAKOS_FEATURED_APP_INSTALL_ACCOUNT_ID,
    TAKOS_FEATURED_APP_INSTALL_SUBJECT: config.TAKOS_FEATURED_APP_INSTALL_SUBJECT,
    TAKOS_FEATURED_APP_INSTALL_MODE: config.TAKOS_FEATURED_APP_INSTALL_MODE,
    TAKOS_FEATURED_APP_INSTALL_RUNTIME_BASE_URL:
      config.TAKOS_FEATURED_APP_INSTALL_RUNTIME_BASE_URL,
