/**
 * Binding formatting helpers for the Cloudflare provider adapter.
 *
 ...
 * tenant runtimes. Supports the provider's binding types: plain_text,
 * secret_text, SQL database, object store, KV, message queue, Analytics
 * Engine, Workflows, Vectorize, Service bindings, and Durable Object
 * namespaces.
 */
...
export function formatBindingForUpdate(
  ...
  if (!binding || typeof binding !== "object") {
    throw new BadRequestError(
      "Invalid provider binding for update: expected object",
    );
  }
  ...
  switch (type) {
    ...
    case "r2_bucket":
      ...
      return {
        type: "r2_bucket",
        name,
        ...(typeof candidate.bucket_name === "string"
    ...
    case "kv_namespace":
      ...
      return {
        type: "kv_namespace",
        name,
        ...(typeof candidate.namespace_id === "string"
    ...
    case "queue":
      ...
      return {
        ...
        ...(typeof candidate.queue_name === "string"
          ...
          : {}),
        ...(typeof candidate.delivery_delay === "number"
          ? { delivery_delay: candidate.delivery_delay }
          : {}),
      };
    case "analytics_engine":
      if (!name) break;
