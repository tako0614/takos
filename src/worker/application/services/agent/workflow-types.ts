...
/**
 * Workflow step lifecycle status. Distinct from RunStatus and
 * DeploymentStatus: workflow steps additionally model a `"skipped"`
 * terminal state when planning decides not to execute the step.
 */
