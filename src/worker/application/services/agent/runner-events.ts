...
import { MAX_EVENT_EMISSION_ERRORS as MAX_EMISSION_ERRORS } from "../../../shared/config/limits.ts";
...
export async function emitEventImpl(
  ...
  try {
    ...
    // Skip SQL store write when object store offload is enabled — the RunNotifierDO writes
    // events to object store segments, making SQL store redundant.
