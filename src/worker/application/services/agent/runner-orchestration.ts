/**
 * Runner Orchestration - Preparation, engine dispatch, cleanup, and message queue jobs.
 *
...
export interface OrchestrationDeps {
  ...
  autoCloseSession: (status: AutoCloseStatus) => Promise<void>;
