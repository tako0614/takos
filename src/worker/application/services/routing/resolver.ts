...
/**
 * Select a concrete service name from a routing target.
 *
...
/**
 * Select a service name from an http-endpoint-set routing target.
 * Uses the longest URL-path-segment-safe pathPrefix match among
 * service-compatible service-ref or http-url endpoints.
 */
