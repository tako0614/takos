...
/** Default embedding model used when the platform AI binding is backed by the provider AI runtime. */
export const EMBEDDING_MODEL = "@cf/baai/bge-base-en-v1.5";

/**
 * Default vector dimensions for Vectorize indexes.
 *
 * Must match the output dimension of `EMBEDDING_MODEL`. The default
...
/** Default maximum remote runtime bundle size for deployments. */
