...
// agent container DO classes (`runtime/container-hosts/executor-host.ts`). The
// previous numeric constants here were never imported by those classes, so
// changing them did nothing. Update the DO class
