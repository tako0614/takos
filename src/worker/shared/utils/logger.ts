 ...
 *
 * NOT a duplicate of @takos/worker-platform-utils's logger.  This module provides:
 ...
 *
 * @takos/worker-platform-utils's logger is a class-based, zero-feature structured logger
 * (no masking, no JSON-parse helpers).  Merging would either strip security
 * features from control or bloat the shared package.
 */
import type { LogLevel } from "@takos/worker-platform-utils";
