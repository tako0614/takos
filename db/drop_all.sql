...
DROP TABLE IF EXISTS tenant_workflow_instances;
...
DROP TABLE IF EXISTS repo_grants;
...
DROP TABLE IF EXISTS memory_claim_edges;
...
DROP TABLE IF EXISTS app_usage_rollups;
DROP TABLE IF EXISTS ap_delivery_queue;

-- Worker / deploy / resource / package
DROP TABLE IF EXISTS publications;
DROP TABLE IF EXISTS service_consumes;
...
DROP TABLE IF EXISTS service_runtime_settings;
DROP TABLE IF EXISTS service_runtimes;
