...
export function FileTree(props: FileTreeProps) {
  ...
  const fetchFiles = async () => {
    try {
      ...
      const newFiles: RepoFile[] = (data.entries || []).map((
        entry: TreeEntry,
      ) => ({
        name: entry.name,
              ...
              <div class="flex flex-col">
                ...
                <Show when={currentPath()}>
                  <div
                    ...
                    onClick={() => {
                      const parentPath = currentPath().split("/").slice(0, -1)
                        .join("/");
                  ...
                  {(file) => (
                    ...
                    >
                      <span class="flex items-center gap-2 min-w-0">
                        <span class="text-zinc-500 dark:text-zinc-400 flex-shrink-0">
                          {getFileIcon(file)}
                        </span>
