      ...
      <div class="flex items-center justify-between gap-3">
        <div>
          ...
          <div class="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
            {props.job.started_at
              ? formatDetailedRelativeDate(props.job.started_at)
              : t("notStarted")}
          </div>
        </div>
        <div class="flex items-center gap-2">
          ...
          >
            ...
            <span>
              {props.loadingJobId === props.job.id ? t("loading") : t("logs")}
            </span>
          </button>
        </div>
      </div>
          ...
          <div class="mt-3 space-y-2">
            ...
            <Show when={logState().hasMore}>
              <button
                ...
                disabled={props.loadingJobId === props.job.id}
              >
                {props.loadingJobId === props.job.id
                  ? t("loading")
                  : t("loadMore")}
              </button>
            </Show>
