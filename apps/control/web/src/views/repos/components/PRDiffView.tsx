    ...
    <div class="max-w-6xl mx-auto">
      <div class="flex items-center gap-4 mb-4 text-sm text-zinc-500">
        ...
        <span class="text-zinc-900 dark:text-zinc-100 font-medium">
          {t("additionsLabel", { count: totalChanges().additions })}
        </span>
        <span class="text-zinc-500 dark:text-zinc-400 font-medium">
          {t("deletionsLabel", { count: totalChanges().deletions })}
        </span>
      </div>
            ...
            <Card padding="none" class="overflow-hidden">
              ...
              >
                <div class="flex items-center gap-3">
                  <Show
                    when={props.expandedFiles.has(file.path)}
                    fallback={
              ...
              <Show when={props.expandedFiles.has(file.path)}>
                <div
                  class="bg-zinc-50 dark:bg-zinc-900 overflow-x-auto border-t"
                ...
                >
                  <For each={file.hunks}>
                    {(hunk) => (
                      <div>
                        <div
                          class="px-4 py-1 bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 text-xs font-mono border-b"
                          style={{
                        ...
                        <div class="font-mono text-xs">
                          <For each={hunk.lines}>
                            {(line) => (
                              ...
                              >
                                <span
                                  class="w-12 px-2 text-right text-zinc-400 select-none border-r"
                                  style={{
                                    "border-color":
                                ...
                                <span
                                  class={`w-4 text-center select-none ${
                                    line.type === "addition"
