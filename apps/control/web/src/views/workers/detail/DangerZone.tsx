...
export function DangerZone({ onDeleteWorker }: DangerZoneProps) {
  ...
  return (
    <div class="p-4 rounded-xl bg-zinc-50 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 mt-8">
      ...
      <button type="button" class="inline-flex items-center gap-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg text-sm font-medium transition-colors" onClick={onDeleteWorker}>
