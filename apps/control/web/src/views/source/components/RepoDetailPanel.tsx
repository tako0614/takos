        ...
        <div class="flex items-center justify-center gap-6 px-6 py-3 border-y border-zinc-100 dark:border-zinc-800">
          ...
          {takopack.available && (
            <div class="flex flex-col items-center gap-0.5 text-emerald-600 dark:text-emerald-400">
              ...
              <span class="text-xs">{formatNumber(takopack.downloads)}</span>
            </div>
          )}
        </div>
          ...
          {takopack.available && (
            <div class="space-y-3">
              <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Takopack</span>
                ...
                <div class="flex flex-wrap gap-1.5">
                  {takopack.tags.map((tag) => (
                    <span
                      ...
                      class="px-2 py-0.5 text-[11px] rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400"
                    >
                      {tag}
                    </span>
                  ))}
