      ...
      <div class="mx-4 my-3 rounded-lg border border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900 overflow-hidden">
        <div class="flex items-center justify-between px-4 py-3 bg-zinc-100 dark:bg-zinc-800 border-b border-zinc-200 dark:border-zinc-700">
          <div class="flex items-center gap-2">
            ...
            <span class="inline-flex items-center justify-center min-w-5 h-5 px-1.5 rounded-full bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 text-xs font-medium">
              {props.sessionDiff.diff!.changes.length}
            </span>
        ...
        <div class="p-4 space-y-3">
          <For each={props.sessionDiff.diff!.changes}>
            {(change) => {
              ...
              return (
                <div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                  ...
                  >
                    ...
                    <span class="flex-1 text-sm text-zinc-900 dark:text-zinc-100 font-mono">
                      {change.path}
                    </span>
                    <span class="text-xs text-zinc-500 dark:text-zinc-400">
                      {change.type}
