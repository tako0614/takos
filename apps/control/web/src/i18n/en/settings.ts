export const settings = {
    ...
    personalWorkspaceNote: 'This is your personal space. It cannot be deleted or shared with others. Use team spaces to collaborate with others.',
    deleteWorkspace: 'Delete Space',
    deleteWorkspaceWarning: 'Are you sure you want to delete this space? This action cannot be undone and all data will be permanently deleted.',
    ...
    removeMemberWarning: 'Are you sure you want to remove this member from the space?',
    ...
    spaceNotFoundDesc: 'The space you are looking for does not exist or you do not have access.',
    personalSpaceNameHint: 'Personal space name cannot be changed',
    personalSpaceNote: 'This is your personal space. It cannot be deleted or shared with others.',
    deleteSpace: 'Delete Space',
    deleteSpaceWarning: 'Are you sure you want to delete this space? This action cannot be undone and all data will be permanently deleted.',
