                      ...
                      >
                        <div style={{ flex: 1, "min-width": "0" }}>
                          ...
                          <Show when={token.last_used_at}>
                            ...
                            >
                              {t("lastUsed", {
                                date: formatShortDate(token.last_used_at!),
                              })}
                            </p>
                          </Show>
                          <p
                          ...
                          >
                            {t("createdDate", {
                              date: formatShortDate(token.created_at),
                            })}
                            {token.expires_at &&
                              ` · ${
                                t("expiresDate", {
                                  date: formatShortDate(token.expires_at),
                                })
                              }`}
                          </p>
                        </div>
        ...
        <Show
          ...
          fallback={
            ...
            >
              ...
              >
                <Button variant="secondary" onClick={resetCreateTokenForm}>
                  {t("cancel")}
                </Button>
                <Button
                  variant="primary"
        ...
        >
          {(token) => (
            ...
            >
              ...
              <Button variant="primary" onClick={resetCreateTokenForm}>
                {t("done")}
              </Button>
            </div>
          )}
