...
describe('platform adapters', () => {
  ...
  it('preserves an attached deployment provider registry when one is supplied by the caller', () => {
    ...
    expect(platform.services.deploymentProviders).toBe(deploymentProviders);
