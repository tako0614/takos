...
// ---------------------------------------------------------------------------
  ...
  getStorageItemByPath = (async () => makeStorageFile({ id: 'f1', type: 'file', name: 'readme.md', path: '/readme.md', size: 100 }),) as any;
    readFileContent = (async () => ({
      file: makeStorageFile({ id: 'f1', name: 'readme.md', path: '/readme.md', type: 'file', size: 100, mime_type: 'text/plain' }),
  ...
  getStorageItemByPath = (async () => makeStorageFile({ id: 'f1', type: 'folder', name: 'docs', path: '/docs', size: 0 }),) as any;
...
// ---------------------------------------------------------------------------
  ...
  writeFileContent = (async () => makeStorageFile({ id: 'f1', name: 'test.md', type: 'file', path: '/test.md', size: 11 }),) as any;
...
// ---------------------------------------------------------------------------
  ...
  createFileWithContent = (async () => makeStorageFile({ id: 'f-new', name: 'plan.md', type: 'file', path: '/docs/plan.md', size: 6 }),) as any;
...
// ---------------------------------------------------------------------------
  ...
  createFolder = (async () => makeStorageFile({ id: 'dir-1', name: 'specs', type: 'folder', path: '/docs/specs', size: 0 }),) as any;
...
// ---------------------------------------------------------------------------
  ...
  deleteStorageItem = (async () => ['key1']) as any;
    deleteR2Objects = (async () => { throw new Error('R2 error'); }) as any;
...
// ---------------------------------------------------------------------------
  ...
  renameStorageItem = (async () => makeStorageFile({ id: 'f1', name: 'new-name.md', type: 'file', path: '/new-name.md', size: 10 }),) as any;
...
// ---------------------------------------------------------------------------
  ...
  moveStorageItem = (async () => makeStorageFile({ id: 'f1', name: 'file.md', type: 'file', path: '/new-dir/file.md', size: 7 }),) as any;
