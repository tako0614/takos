...
Deno.test("executeWithCompensation - runs compensation actions in reverse on failure", async () => {
  ...
  const steps: TransactionStep[] = [
    {
      description: "step 1",
      execute: createMockStatement() as any,
      compensate: compensate1 as any,
    },
    {
      description: "step 2",
      execute: createMockStatement() as any,
      compensate: compensate2 as any,
    },
    {
      description: "step 3",
      execute: createMockStatement(undefined, true) as any,
    },
  ];
  ...
  const steps: TransactionStep[] = [
    {
      description: "step 1",
      execute: createMockStatement() as any,
      compensate: failingCompensation as any,
    },
    {
      description: "step 2",
      execute: createMockStatement(undefined, true) as any,
...
Deno.test("executeWithCompensation - returns partial results up to the failed step", async () => {
  const steps: TransactionStep[] = [
    {
      description: "step 1",
      execute: createMockStatement({ success: true, data: "one" }) as any,
    },
    {
      description: "step 2",
      execute: createMockStatement(undefined, true) as any,
