...
const mocks = {
  ...
  deleteThread: ((..._args: any[]) => undefined) as any,
...
function createApp(user: User) {
  ...
  Object.assign(threadsRouteDeps, {
    ...
    createThread: (...args: any[]) => mocks.createThread(...args),
    deleteThread: (...args: any[]) => mocks.deleteThread(...args),
    listThreads: (...args: any[]) => mocks.listThreads(...args),
    updateThread: (...args: any[]) => mocks.updateThread(...args),
    updateThreadStatus: (...args: any[]) => mocks.updateThreadStatus(...args),
    createThreadShare: (...args: any[]) => mocks.createThreadShare(...args),
    listThreadShares: (...args: any[]) => mocks.listThreadShares(...args),
    revokeThreadShare: (...args: any[]) => mocks.revokeThreadShare(...args),
    searchSpaceThreads: (...args: any[]) => mocks.searchSpaceThreads(...args),
    ...
    exportThread: (...args: any[]) => mocks.exportThread(...args),
    getPlatformServices: (...args: any[]) => mocks.getPlatformServices(...args),
  });
...
Deno.test("threads routes - GET /api/spaces/:spaceId/threads - passes status filter", async () => {
  ...
  mocks.listThreads = createRecordedMock(async () => []) as any;
...
Deno.test("threads routes - POST /api/spaces/:spaceId/threads - creates a thread and returns 201", async () => {
  ...
  mocks.createThread =
    (async () => ({ id: "t-new", title: "New Thread" })) as any;
...
Deno.test("threads routes - GET /api/threads/:id - returns thread with access role", async () => {
  ...
  assert("thread" in json);
  assert("role" in json);
  assertEquals((json as any)["role"], "owner");
});
...
Deno.test("threads routes - DELETE /api/threads/:id - soft-deletes a thread", async () => {
  ...
  mocks.deleteThread = createRecordedMock(async () => undefined) as any;
...
Deno.test("threads routes - POST /api/threads/:id/archive - archives a thread", async () => {
  ...
  mocks.updateThreadStatus = createRecordedMock(async () => undefined) as any;
