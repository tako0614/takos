...
Deno.test("profiles view routes - GET /:username - returns profile with repos for existing user", async () => {
  ...
  profilesViewRouteDeps.getUserByUsername = mocks.getUserByUsername;
  profilesViewRouteDeps.getUserStats = mocks.getUserStats;
  profilesViewRouteDeps.isFollowing = mocks.isFollowing;
  profilesViewRouteDeps.batchStarCheck = mocks.batchStarCheck;
  profilesViewRouteDeps.getDb = (() => mockDbChain([])) as any;
...
Deno.test("profiles view routes - GET /:username/repos - returns repos with pagination metadata", async () => {
  ...
  const app = createApp();
  profilesViewRouteDeps.getDb = (() => chain) as any;
  profilesViewRouteDeps.getUserByUsername = mocks.getUserByUsername;
  profilesViewRouteDeps.getUserStats = mocks.getUserStats;
  profilesViewRouteDeps.isFollowing = mocks.isFollowing;
  profilesViewRouteDeps.batchStarCheck = mocks.batchStarCheck;
