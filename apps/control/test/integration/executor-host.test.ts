...
import { assertEquals } from 'jsr:@std/assert';
  ...
  assertEquals(getRequiredProxyCapability('/proxy/db/first'), 'bindings');
    ...
    assertEquals(getRequiredProxyCapability('/rpc/control/run-record'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/run-bootstrap'), 'control');
    ...
    assertEquals(getRequiredProxyCapability('/proxy/billing/run-usage'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/billing-run-usage'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/run-context'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/no-llm-complete'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/conversation-history'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/skill-plan'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/memory-activation'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/memory-finalize'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/add-message'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/update-run-status'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/current-session'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/is-cancelled'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/tool-catalog'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/tool-execute'), 'control');
    assertEquals(getRequiredProxyCapability('/rpc/control/tool-cleanup'), 'control');
  ...
  assertEquals(validateProxyResourceAccess('/proxy/queue/send', {}, { queue: 'index' }), true);
    assertEquals(validateProxyResourceAccess('/proxy/queue/send', {}, { queue: 'other' }), false);
})
  Deno.test('executor-host proxy capability boundaries - allows only runtime-host URLs on the runtime proxy allowlist', () => {
  assertEquals(validateProxyResourceAccess('/proxy/runtime/fetch', {}, {
  ...
  assertEquals(validateProxyResourceAccess('/proxy/browser/fetch', {}, {
