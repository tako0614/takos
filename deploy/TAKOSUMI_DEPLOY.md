...
release_container_images = {
  runtime  = "registry.cloudflare.com/<account-id>/takos-worker-runtime:0.10.24-<commit>"
  executor = "registry.cloudflare.com/<account-id>/takos-agent:0.10.24-<commit>"
}
```
