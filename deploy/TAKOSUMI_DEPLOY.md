...
release_container_images = {
  runtime  = "registry.cloudflare.com/<account-id>/takos-worker-runtime:0.10.6-<commit>"
  executor = "registry.cloudflare.com/<account-id>/takos-agent-executor:0.10.6-<commit>"
}
```
