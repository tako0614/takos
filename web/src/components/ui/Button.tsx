...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    "bg-[var(--color-primary)] text-[var(--color-text-inverted)] hover:bg-[var(--color-primary-hover)]",
  secondary:
    "bg-[var(--color-surface-secondary)] text-[var(--color-text-primary)] border border-[var(--color-border-primary)] hover:bg-[var(--color-bg-tertiary)]",
  ghost:
...
export function Button(props: ButtonProps) {
  ...
  return (
    <button
      type="button"
      class={`${baseClasses} ${variantClasses[local.variant ?? "primary"]} ${
