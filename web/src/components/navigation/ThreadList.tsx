...
const THREAD_BASE =
  "group flex items-center gap-3 px-3 py-2 rounded-lg cursor-pointer transition-colors min-h-[36px] text-sm";
...
export function ThreadList(props: ThreadListProps) {
  const { t } = useI18n();
  const { onSelectThread, onDeleteThread, onToggleArchiveThread } =
    useSidebarCallbacks();
