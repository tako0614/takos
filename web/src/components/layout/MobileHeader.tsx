...
export function MobileHeader(props: MobileHeaderProps) {
  ...
  return (
    <div
      class="fixed top-0 left-0 right-0 z-30 bg-white/95 dark:bg-zinc-900/95 backdrop-blur supports-[backdrop-filter]:bg-white/80 supports-[backdrop-filter]:dark:bg-zinc-900/80 border-b border-zinc-200 dark:border-zinc-800 flex items-end"
      style={{
        "padding-top": "var(--spacing-safe-top, 0px)",
        height: "calc(48px + var(--spacing-safe-top, 0px))",
      }}
    >
