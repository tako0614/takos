                  ...
                  <div class="min-w-0 flex items-center gap-3">
                    ...
                    <div class="min-w-0">
                      ...
                      <div class="text-xs text-zinc-400 truncate">
                        {t("sourceLabel")}: {item.repository_url}
                      </div>
                      <div class="text-xs text-zinc-400 truncate">
                        {t("trackingLabel")}: {formatTrackingRefLabel({
                          kind: "git_ref",
                        ...
                        {shortCommit(item.default_branch_hash)
                          ? ` @ ${shortCommit(item.default_branch_hash)}`
                          : ""}
                      </div>
                    </div>
...
function RepositoryIcon(props: {
  ...
  return iconSrc()
    ...
    : (
      <div class="w-9 h-9 rounded-lg bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 flex items-center justify-center text-xs font-semibold text-zinc-500 dark:text-zinc-300 flex-shrink-0">
        {initial()}
      </div>
    );
}
