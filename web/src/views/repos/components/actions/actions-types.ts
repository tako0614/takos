import type { TranslationKey, TranslationParams } from '../../../../store/i18n.ts';
 ...
 * ('pending'|'queued'|'running'|'completed'|'failed'|'cancelled') in the
 * shared API contract.
 *
 * Extends the engine definition (src/worker/actions-engine/workflow-models.ts) with 'waiting',
