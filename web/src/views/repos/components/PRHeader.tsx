    ...
    <>
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-3 flex-1">
            <h1 class="text-lg font-semibold text-zinc-900 dark:text-zinc-100">
              ...
              <span class="ml-2 text-zinc-500 dark:text-zinc-400 font-normal">
                #{props.pr.number}
              </span>
            </h1>
      ...
      >
        <div class="flex items-center gap-4 text-sm text-zinc-500 flex-wrap">
          ...
          <code class="px-2 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 text-xs font-mono border border-zinc-200 dark:border-zinc-700">
            {props.pr.source_branch}
          </code>
          <span>{t("intoLabel")}</span>
          <code class="px-2 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-zinc-800 dark:text-zinc-200 text-xs font-mono border border-zinc-200 dark:border-zinc-700">
            {props.pr.target_branch}
          </code>
        </div>
