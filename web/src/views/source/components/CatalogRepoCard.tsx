  ...
  return (
    ...
    >
      ...
      <Show when={displaySource()}>
        {(source) => (
          <div class="mt-2 space-y-0.5 text-[10px] leading-snug text-zinc-400 dark:text-zinc-500">
            <p
              class="truncate"
            ...
            >
              ...
              {formatRepositorySourceLabel(source().repository_url)}
            </p>
            <p class="truncate">
              <span class="font-medium text-zinc-500 dark:text-zinc-400">
                {t("trackingLabel")}:
            ...
            <Show when={installedValue()}>
              {(installed) => (
                <p class="truncate">
                  <span class="font-medium text-zinc-500 dark:text-zinc-400">
                    {installed().kind === "commit"
