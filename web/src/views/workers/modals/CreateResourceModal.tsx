    ...
    >
      ...
      >
        <div class="flex items-center justify-between px-6 py-4 border-b border-zinc-200 dark:border-zinc-700">
          <h3
            id="create-resource-modal-title"
        ...
        <div class="p-6 space-y-4">
          <div class="space-y-2">
            ...
            <input
              ...
              onInput={(e) => props.onResourceNameChange(e.currentTarget.value)}
          ...
          <div class="space-y-2">
            ...
            <select
              ...
              onChange={(e) =>
                props.onResourceTypeChange(
                  e.currentTarget.value as Resource["type"],
                )}
            >
              <option value="sql">{t("d1Database")}</option>
              <option value="object-store">{t("r2Storage")}</option>
              <option value="key-value">{t("kvStore")}</option>
              <option value="vector-index">{t("vectorizeIndex")}</option>
            </select>
          </div>
        </div>
        <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-zinc-200 dark:border-zinc-700">
          ...
          <button
            ...
            disabled={props.creating || !props.resourceName.trim()}
            aria-disabled={props.creating || !props.resourceName.trim()}
          >
