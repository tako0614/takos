...
export type { ToolExecution } from "takos-api-contract/shared/types";
export type { AgentTaskStatus } from "takos-api-contract/shared/types";
export type { AgentTaskPriority } from "takos-api-contract/shared/types";
export type { AgentTaskBase } from "takos-api-contract/shared/types";
export type { AgentTaskRunSummary } from "takos-api-contract/shared/types";
...
export interface Message
  extends Omit<BackendMessage, "tool_calls" | "tool_call_id"> {
