...
export interface PullRequest {
  ...
  author: {
    id: string;
    /**
     * Resolved human display name/handle, or `null` when the git service only
     * carries the opaque account id. The UI must render a clear fallback (not
     * the raw id stuffed into the name slot) when this is `null`.
     */
    name: string | null;
    avatar_url?: string;
  };
