export const common = {
  ...
  unlock: "解除",
  invalidSharePassword: "共有パスワードが正しくありません。",
  sharePasswordRateLimited:
    "パスワードの試行回数が上限に達しました。{seconds}秒後に再試行してください。",
  sharePasswordRequirements:
    "空白以外を8文字以上含み、256文字以内のパスワードを指定してください。",
  shareExpiryDaysInvalid: "有効期限は1日から365日の整数で指定してください。",
  shareNotAvailable: "この共有リンクは利用できません。",
  sharedMessageDataTruncated:
    "大きすぎる、または取得できないメッセージデータの一部を上限付きプレビューで表示しています。",
  ...
  subscribed: "購読中",
  queryResult: "クエリ結果",
  categoryNavigation: "カテゴリーナビゲーション",
  ...
  unarchivingThread: "解除中...",
  archivedThreadNotice:
    "このスレッドはアーカイブされています。再開するにはアーカイブを解除してください。",
