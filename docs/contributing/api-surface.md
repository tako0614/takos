...
Workspace / Project / Capsule / Source / ProviderConnection / ProviderBinding / Run / StateVersion / Output / AuditEvent を扱う
...
- deploy-control API: Workspace / Project / Source / Capsule / Run / StateVersion / Output routes
