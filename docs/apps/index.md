...
この章が扱うのは app の deploy/runtime contract です。
Takos の product boundary は [Kernel](/architecture/kernel) を参照。
...
| [Services](/apps/services)           | standalone container workload の定義          |
...
- [Kernel](/architecture/kernel) --- Takos kernel と app の境界を確認する
