...
この表にない nested route は public API ではありません。新規 route を増やす場合は owning service の contract と
apps/api gateway の責務を先に決め、unknown route は control backend に proxy せず 404 を返します。
