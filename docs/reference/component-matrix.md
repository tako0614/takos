...
| `paas/`  | `https://github.com/tako0614/takosumi.git`  | service repo | PaaS control plane, deploy/runtime lifecycle, tenant/platform domains, canonical agent-control RPC | `cd paas && deno task check` |
