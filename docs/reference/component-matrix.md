...
| `paas/`  | `https://github.com/tako0614/takos-paas.git`  | service repo | PaaS control plane, deploy/runtime lifecycle, tenant/platform domains | `cd paas && deno task check` |
...
| `agent/` | `https://github.com/tako0614/takos-agent.git` | service repo | agent execution service and PaaS control RPC client                   | `cd agent && cargo test`     |
