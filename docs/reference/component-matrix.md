...
| `../takosumi/` | `https://github.com/tako0614/takosumi.git`  | sibling repo | Takosumi kernel/control plane, deploy/runtime lifecycle, tenant/platform domains, canonical agent-control RPC | `cd ../takosumi && deno task check` |
