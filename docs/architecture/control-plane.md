...
| ------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------- |
| **Account plane**  | Takosumi Accounts (`takosumi.account.auth@v1` / `takosumi.account.billing@v1`) | account / login / passkey / upstream IdP broker / OAuth / OIDC issuer / Stripe / billing / AppInstallation / AppBinding / AppGrant   | manifest apply / provider DAG / Deployment lifecycle / routing materialization   |
