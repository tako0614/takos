...
であり、public managed offering を開くには別途 launch-readiness evidence / operator approval / staged rehearsal が必要です。
...
`identity.primary.oidc` / OIDC discovery で得た issuer URL を `OIDC_ISSUER_URL`
