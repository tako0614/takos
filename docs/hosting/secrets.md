...
installation ごとに発行し、`identity.oidc@v1` AppBinding 経由で
...
| `INSTALL_LAUNCH_INSTALLATION_ID` | `install-launch-token@v1` AppBinding | この Installation の id (`inst_xxx`)。redeem 要求の identity context                                                                         |
