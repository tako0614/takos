...
- [Takosumi Accounts のアーキテクチャ](https://github.com/tako0614/takosumi-cloud/blob/main/docs/architecture/takosumi-accounts.md)
...
- `src/routes/public`: ブラウザ・API 向けゲートウェイ。セッション管理と Takos product API
  を提供
- `src/worker`: product-owned internal control backend。account / billing /
  OIDC issuer は持たない
