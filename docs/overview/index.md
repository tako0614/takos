...
`.takosumi.yml` と `.takosumi.yml` を Git リポジトリに追加し、
...
shared-cell → dedicated は Installation contract 上の materialize target です。current public docs では live data
...
既存 Installation の export/import は contract / API と local proof があります。production provider ごとの full
...
- [Installation](https://github.com/tako0614/takosumi-cloud/blob/master/docs/architecture/app-installation.md) — 所有権の台帳
