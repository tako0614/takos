...
を指定してインストールします。Takosumi が Installation を作り、PlanRun / ApplyRun を経て Deployment / DeploymentOutput
まで自動で記録します。
...
より詳しいデータモデル (Installation、PlanRun、ApplyRun、Deployment、DeploymentOutput、operator account-plane records
など) については以下を参照してください。
...
- [Takosumi Installation Lifecycle](https://github.com/tako0614/takos-ecosystem/blob/master/docs/platform/installable-app-model.md)
  —アプリインストールの仕組み
- [Installation](https://github.com/tako0614/takosumi/blob/main/docs/architecture/app-installation.md) —
  所有権の台帳
