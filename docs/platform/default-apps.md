...
| [takos-docs](/platform/takos-docs)         | リッチテキストエディタ          | UiSurface, McpServer, takos-api |
| [takos-excel](/platform/takos-excel)       | スプレッドシート                | UiSurface, McpServer, takos-api |
| [takos-slide](/platform/takos-slide)       | プレゼンテーション              | UiSurface, McpServer, takos-api |

## 動作原理

各 group は独立した app / group として deploy され、内部に worker / service /
attached container compute を持ちうる。
