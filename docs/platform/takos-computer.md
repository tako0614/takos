...
- kernel の Storage / Memory / Thread / Run / Repository / MCP API に capability grant 経由でアクセス
...
publication ではなく、kernel API への capability grant です。
...
scope は manifest の capability grant と operator policy に従って通常通り
管理される。
