...
> itself, **Takosumi kernel** is treated as the Capsule / typed Runs /
> StateVersion / Output run-ledger processor and never holds identity,
...
> owns OIDC issuance, Capsule ownership, and operator BillingPort billing.
