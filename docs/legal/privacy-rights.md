...
| Export   | `GET`  | `/api/me/privacy/export`            | account / settings / auth identity metadata / OAuth metadata / billing metadata (※下記注記参照) / repositories / threads / messages / runs / memories / notifications を JSON attachment として返す |
