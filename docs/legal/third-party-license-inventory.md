...
`takos/deno.lock` is not part of the current shell repo. The ecosystem root CI
must not require it unless the shell starts installing dependencies directly.
