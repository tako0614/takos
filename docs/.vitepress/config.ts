    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Core Contract v1.0', link: '/takosumi/core/01-core-contract-v1.0' },
          { text: 'v1.0 Implementation Checklist', link: '/takosumi/10-v1.0-implementation-checklist' },
          {
            text: 'Authoring Guides',
            items: [
              { text: 'Authoring Guide', link: '/takosumi/guides/authoring-guide' },
              { text: 'Descriptor Authoring', link: '/takosumi/guides/descriptor-authoring-guide' },
              { text: 'Plugin Authoring', link: '/takosumi/guides/plugin-authoring-guide' },
            ],
          },
          {
            text: 'Implementation',
            items: [
              { text: 'Implementation Strategy', link: '/takosumi/implementation/implementation-strategy' },
              {
                text: 'Cloudflare Containers Strategy',
                link: '/takosumi/implementation/cloudflare-containers-strategy',
              },
              { text: 'Provider Descriptor Catalog', link: '/takosumi/implementation/provider-descriptor-catalog' },
              {
              ...
              { text: 'Cloudflare Workers Provider', link: '/takosumi/implementation/providers/cloudflare-workers' },
            ],
          },
          { text: 'Official Descriptor Set v1', link: '/takosumi/descriptors/official-descriptor-set-v1' },
          {
            text: 'Tests',
            items: [
              { text: 'Conformance Tests', link: '/takosumi/tests/conformance-tests' },
              { text: 'Condition Reason Catalog', link: '/takosumi/tests/condition-reason-catalog' },
            ],
          },
        ],
      },
