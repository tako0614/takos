...
新しい Workspace に app は自動 install されません。まず Apps を開き、Git URL または installable app 候補から必要な app を追加します。

- `takos-office`: 文書、スライド、表計算を 1 つの Office worker で扱う
- `takos-computer`: agent が browser automation / computer use を行う
- `yurucommu`: 自分で運用できる social / community app
...
自分の app、fork、third-party app も Git URL から追加します。Takos の Store / Source 画面は中央の公式 registry ではなく、
